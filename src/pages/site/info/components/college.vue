<template>
                                    ...
                                    <div class="mb-0" v-if="properties.social != null">
                                        <div class="mb-0">
                                            <tr role="row" class="row"
                                                ...
                                                <td role="cell" class="col-4">{{data.social}}</td>
                                                <td role="cell" class="col-8"><a class="pcolor" :href="data.link"
                        ...
                        <div class="card-body parab-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col-10 px-2">
                                    ...
                                    <div class="mb-0" v-if="properties.approved_by">

                                    </div>
                                    <div class="mb-0" v-else>Add Or Edit Approved By</div>
                                </div>
                                <div class="col-1 px-1"><i class="fa fa-pencil pcolor edit-pencil"
                                                           v-b-modal.approved_by></i></div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-1 px-1  text-center"><i class="fa fa-cubes pcolor edit-pencil"></i>
                                ...
                                <div class="col-10 px-2">
                                    <p class="font-weight-bold">Affiliated By</p>
                                    <div v-if="properties.affiliatedBy"></div>
                                    <div class="mb-0" v-else>Add Or Edit Affiliated By</div>
                                </div>
                                <div class="col-1 px-1"><i class="fa fa-pencil pcolor edit-pencil"
                                                           v-b-modal.affiliated_by></i></div>
                            </div>
                            <hr>
                            <div class="row">
                                <div class="col-1 px-1  text-center"><i
            ...
            <div class="row" v-for="(data,i) in socialItems" :key="i">
                <div class="col-xl-3 col-md-4 col-sm-4 col-xs-4">
                    <div class="form-group mt-2">
                        ...
                        <b-form-select v-model="data.social" :value="data.social" :options="socialTypes"></b-form-select>
                    </div>
                </div>
    ...
    background: whitesmoke;"><i class="fa fa-close"></i></div>
        ...
        <b-modal id="approved_by"
                 centered
                 @ok="addApprovedBy"
                 @cancel="approvedByText = null"
                 @close="approvedByText = null"
                 title="Approved By"
                 ok-title="Update"
                 class="theme-modal">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <b-input type="text" placeholder="Type Approved By Name!" ></b-input>
                </div>
            </div>
        </b-modal>

        <b-modal id="affiliated_by"
                 centered
                 @ok="addAffiliatedBy"
                 @cancel="affiliatedByText = null"
                 @close="affiliatedByText = null"
                 title="Approved By"
                 ok-title="Update"
                 class="theme-modal">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <b-input type="text" placeholder="Type Affiliated By Name!" ></b-input>
                </div>
            </div>
        </b-modal>
    </div>
        ...
        methods: {
            ...
            getProperties(val) {
                ...
                axios.post(api.getProperty, {
                    ...
                    this.propertyLink = 'yoga-in-'+ (res.data[0].city != null ? res.data[0].city.name.toLowerCase():'')+'/'+(res.data[0].seo.length != 0 ? res.data[0].seo[0].permalink:'')
                    this.contacts = []
