                        ...
                        <div class="card-body parab-0">
                            ...
                            <div class="row">
                                ...
                                <div class="col-10 px-2">
                                    <p class="font-weight-bold">Service Area</p>
                                    <p v-if="properties.location && properties.location != null">
                                        {{properties.location.address != null ? properties.location.address : ""}}, {{properties.city.name}}, {{properties.state.name}}
                                    </p>
                            ...
                            <div class="row">
                                ...
                                <div class="col-10 px-2">
                                    ...
                                    <div class="mb-0" v-if="properties.social != null && properties.social.links != null">
                                        <div class="mb-0">
            ...
            getProperties(val) {
                ...
                axios.post(api.getProperty, {
                    ...
                    if (res.data[0].social != null) {
                        if (res.data[0].social.link != null) {
