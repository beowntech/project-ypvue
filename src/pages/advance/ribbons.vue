<template>
    <div>
        <Breadcrumbs main="Advance" title="ribbons"/>
              ...
              <div class="col-sm-14 col-xl-4">
                <div class="ribbon-wrapper-right card">
                  <div class="card-body">
                    ...
                    <p>Lorems Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text.</p>
                  </div>
                </div>
              </div>
              <div class="col-sm-14 col-xl-4">
