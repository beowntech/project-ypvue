  ...
  <div class="header-wrapper row m-0">
    ...
    <div class="header-logo-wrapper">
      <div class="logo-wrapper">
        <router-link to="/">
          <img class="img-fluid" src="../assets/images/logo/logo.png" alt="site Logo" />
        </router-link>
      </div>
...
<!--        </li>-->
        ...
        <li class="profile-nav onhover-dropdown p-0 mr-0">
          <div class="media profile-media">
            ...
            />
            <div class="media-body">
              <span v-text="userName">User Name</span>
              <p class="mb-0 font-roboto" >
                <span v-text="userRole.toUpperCase()" class="mr-2"></span>  <i style="margin-top: 0px!important;" class="middle fa fa-angle-down"></i>
              </p>
            </div>
          </div>
